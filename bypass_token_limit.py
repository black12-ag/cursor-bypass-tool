...
def modify_workbench_js(file_path: str, translator=None) -> bool:
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(mode="w", encoding="utf-8", errors="ignore", delete=False) as tmp_file:
            ...
            patterns = {
                # 通用按钮替换模式
                r'B(k,D(Ln,{title:"Upgrade to Pro",size:"small",get codicon(){return A.rocket},get onClick(){return t.pay}}),null)': r'B(k,D(Ln,{title:"munir GitHub",size:"small",get codicon(){return A.github},get onClick(){return function(){window.open("https://github.com/black12-ag/cursor-bypass-tool","_blank")}}}),null)',
                
                # Windows/Linux
                r'M(x,I(as,{title:"Upgrade to Pro",size:"small",get codicon(){return $.rocket},get onClick(){return t.pay}}),null)': r'M(x,I(as,{title:"munir GitHub",size:"small",get codicon(){return $.github},get onClick(){return function(){window.open("https://github.com/black12-ag/cursor-bypass-tool","_blank")}}}),null)',
                
                # Mac 通用按钮替换模式
                r'$(k,E(Ks,{title:"Upgrade to Pro",size:"small",get codicon(){return F.rocket},get onClick(){return t.pay}}),null)': r'$(k,E(Ks,{title:"munir GitHub",size:"small",get codicon(){return F.rocket},get onClick(){return function(){window.open("https://github.com/black12-ag/cursor-bypass-tool","_blank")}}}),null)',
                # Badge 替换
